...
if(!CModule::IncludeModule("catalog")){
	...
	if(!empty($_REQUEST['generate_cache_iblock'])){
		...
		$arFilter = array('ACTIVE' => 'Y', '!UF_PSEUDO_SECTION' => false, 'CHECK_PERMISSIONS' => 'N');
	...
	if(!empty($_REQUEST['generate_cache_iblock_props'])){
		...
		$boolCond = $obCond->Init(BT_COND_MODE_GENERATE, BT_COND_BUILD_CATALOG, array());
		$res = CIBlockSection::GetList(array("left_margin"=>"ASC"), array('ACTIVE'=>'Y', '!UF_PSEUDO_SECTION'=>false), true, array('ID', 'IBLOCK_ID', 'CODE', 'IBLOCK_SECTION_ID','UF_PSEUDO_SECTION'));
