...
Class new_pseudosection extends CModule
{
	var $MODULE_ID = "new.pseudosection";
	var $MODULE_VERSION;
	var $MODULE_VERSION_DATE;
	var $MODULE_NAME;
	var $MODULE_DESCRIPTION;
	var $MLANG = "WP_PSEUDOSECTION_NEW_";

	function new_pseudosection()
	{
		$this->MODULE_VERSION      = WP_PSEUDOSECTION_NEW_VERSION;
		$this->MODULE_VERSION_DATE = WP_PSEUDOSECTION_NEW_VERSION_DATE;
