	...
	public static function GetLogic($arOperators = false)
	{
		$arOperatorsList = array(
			...
			BT_COND_LOGIC_GR => array(
				...
				'OP' => array(
					'N' => '#FIELD# > #VALUE#',
					//'Y' => 'CCGlobalCondCtrllNew::LogicGreat(#FIELD#, #VALUE#)'
					'Y' => '">#FIELD#" => "#VALUE#"'
				),
				'VALUE' => 'Great',
			...
			BT_COND_LOGIC_LS => array(
				...
				'OP' => array(
					'N' => '#FIELD# < #VALUE#',
					//'Y' => 'CCGlobalCondCtrllNew::LogicLess(#FIELD#, #VALUE#)'
					'Y' => '"<#FIELD#" => "#VALUE#"'
				),
				'VALUE' => 'Less',
			...
			BT_COND_LOGIC_EGR => array(
				...
				'OP' => array(
					'N' => '#FIELD# >= #VALUE#',
					//'Y' => 'CCGlobalCondCtrllNew::LogicEqualGreat(#FIELD#, #VALUE#)'
					'Y' => '">=#FIELD#" => "#VALUE#"'
				),
				'VALUE' => 'EqGr',
			...
			BT_COND_LOGIC_ELS => array(
				...
				'OP' => array(
					'N' => '#FIELD# <= #VALUE#',
					//'Y' => 'CCGlobalCondCtrllNew::LogicEqualLess(#FIELD#, #VALUE#)'
					'Y' => '"<=#FIELD#" => "#VALUE#"'
				),
				'VALUE' => 'EqLs',
			...
			BT_COND_LOGIC_CONT => array(
				...
				'OP' => array(
					'N' => '"%#FIELD#" => "#VALUE#"',
					//'Y' => 'CCGlobalCondCtrllNew::LogicContain(#FIELD#, #VALUE#)'
					'Y' => '"#FIELD#" => "%#VALUE#%"'
				),
				'VALUE' => 'Contain',
			...
			BT_COND_LOGIC_NOT_CONT => array(
				...
				'OP' => array(
					'N' => '"!%#FIELD#" => "#VALUE#"',
					//'Y' => 'CCGlobalCondCtrllNew::LogicNotContain(#FIELD#, #VALUE#)'
					'Y' => '"!#FIELD#" => "%#VALUE#%"'
				),
				'VALUE' => 'NotCont',
			...
			if (!$boolValueError)
			{
				...
				switch ($arControl['FIELD_TYPE'])
				{
					...
					case 'datetime':
						...
						$boolValueError = CCGlobalCondCtrllNew::ConvertInt2DateTime($arOneCondition['value'], $strFormat, $intOffset);
						break;
					default:
						$boolValueError = true;
						break;
			...
			if (!$boolError)
			{
				...
				switch ($arControl['FIELD_TYPE'])
				{
					...
					case 'datetime':
						...
						$boolError = CCGlobalCondCtrllNew::ConvertDateTime2Int($arOneCondition['value'], $strFormat, $intOffset);
						break;
					default:
						$boolError = true;
						break;
					...
					else
					{
						...
						switch ($arOneAtom['ATOM']['FIELD_TYPE'])
						{
							...
							case 'datetime':
								...
								$boolAtomError = CCGlobalCondCtrllNew::ConvertInt2DateTime($arOneCondition[$strID], $strFormat, $intOffset);
								break;
							default:
								$boolAtomError = true;
						}
					...
					if (!$boolAtomError)
					{
						switch ($arOneAtom['ATOM']['FIELD_TYPE'])
						{
							...
							case 'datetime':
								...
								$boolAtomError = CCGlobalCondCtrllNew::ConvertDateTime2Int($arOneCondition[$strName], $strFormat, $intOffset);
								break;
							default:
								$boolAtomError = true;
						}
...
class CCGlobalCondCtrllNewComplex extends CCGlobalCondCtrllNew
{
	public static function GetClassName()
	{
		return __CLASS__;
...
class CCGlobalCondCtrllNewGroup extends CCGlobalCondCtrllNew
{
	public static function GetClassName()
	{
		return __CLASS__;
...
class CCCatalogCondCtrlNew extends CCGlobalCondCtrllNew
{
	public static function GetClassName()
	{
		return __CLASS__;
...
class CCCatalogCondCtrlNewComplex extends CCGlobalCondCtrllNewComplex
{
	public static function GetClassName()
	{
		return __CLASS__;
...
class CCCatalogCondCtrlNewGroup extends CCGlobalCondCtrllNewGroup
{
	public static function GetClassName()
	{
		return __CLASS__;
...
class CCCatalogCondCtrlNewIBlockFields extends CCCatalogCondCtrlNewComplex
{
	public static function GetClassName()
	{
		return __CLASS__;
...
class CCCatalogCondCtrlNewIBlockProps extends CCCatalogCondCtrlNewComplex
{
	public static function GetClassName()
	{
		return __CLASS__;
			...
			if (!isset($this->arControlList))
			{
				...
				foreach (GetModuleEvents($this->arEvents['CONTROLS']['MODULE_ID'], $this->arEvents['CONTROLS']['EVENT_ID'], true) as $arEvent)
				{
					if ($arEvent['TO_CLASS'] == 'CCatalogCondCtrlIBlockProps') {
						$arEvent['TO_CLASS'] = 'CCCatalogCondCtrlNewIBlockProps';
						$arEvent['TO_NAME'] = 'CCCatalogCondCtrlNewIBlockProps::GetControlDescr (catalog)';
					}elseif($arEvent['TO_CLASS'] == 'CCatalogCondCtrlIBlockFields'){
						$arEvent['TO_CLASS'] = 'CCCatalogCondCtrlNewIBlockFields';
						$arEvent['TO_NAME'] = 'CCCatalogCondCtrlNewIBlockFields::GetControlDescr (catalog)';
				...
				if (isset($this->arControlList[$arLevel['CLASS_ID']]))
				{
					...
					if ('Y' == $arOneControl['GROUP'])
					{
						...
						if($arOneControl['Generate'][0] == 'CCatalogCondCtrlGroup'){
							$arOneControl['Generate'][0]='CCCatalogCondCtrlNewGroup';
						}
					...
					if (isset($this->arControlList[$arOneCondition['CLASS_ID']]))
					{
						...
						else
						{
							...
							if($arOneControl['Generate'][0] == 'CCatalogCondCtrlIBlockProps'){
								$arOneControl['Generate'][0]='CCCatalogCondCtrlNewIBlockProps';
							}
							//dump($arOneControl['Generate']);
							$strEval = call_user_func_array($arOneControl['Generate'],
...
class CCCatalogCondTreeNew extends CCGlobalCondTreeNew
{
	public function __construct()
	{
		parent::__construct();
