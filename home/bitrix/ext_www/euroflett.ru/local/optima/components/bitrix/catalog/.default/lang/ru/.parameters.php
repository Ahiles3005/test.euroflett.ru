...
$MESS["CPT_BC_SHOW_SECTION_PRODUCT_QUANTITY"] = "Указывать количество в списке товаров";
...
$MESS["CP_BCE_TPL_HIDDEN_PROP"] = "Спрятанные свойства товара";
...
$MESS["WP_ITEMLIST_CATEGORY_LINE"] = "Свойство для отображения над заголовком товара";
$MESS["WP_SHOW_MENU_GROUPS"] = "Выводить только разделы с указанной группой меню";
$MESS["WP_SPLIT_BY_MENU_GROUPS"] = "Делить вывод на группы меню";
$MESS["WP_CONVERT_PRICE_FROM"] = "Цены товаров заданы в валюте";
?>