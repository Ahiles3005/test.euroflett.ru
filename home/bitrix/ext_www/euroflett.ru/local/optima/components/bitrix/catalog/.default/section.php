...
if(preg_match('~^404~i', CHTTP::GetLastStatus())) { 
    ...
    <?
    include $_SERVER['DOCUMENT_ROOT'].'/404.php'; return; 
} 
        ...
        <div class="catalog-sort-and-view">
            <div class="catalog-sort">
                ...
                <ul class="sort-by-options">
                    <? foreach ($arSort as $key => $ar) {
                        ...
                        <li class="<?= $class ?>"><a href="<?= $href ?>" rel="nofollow"><?= $ar['TITLE'] ?></a></li>
                    <? } ?>
                </ul>
            </div>
            <div class="catalog-show-by">
                ...
                <select class="show-by-options" data-action="change-count-catalog-items">
                    ...
                    <option value="21" <?=(intval($_REQUEST['showby'])==21 || !$_REQUEST['showby']) ? 'selected' : ''?>>21</option>
            ...
            if (!empty($arRecomData))
            {
				...
				$APPLICATION->IncludeComponent(
					...
					array(
						...
						'HIDE_NOT_AVAILABLE' => $arParams["HIDE_NOT_AVAILABLE"],
						"ELEMENT_COUNT" => ($sectionItemCount<9?15-$sectionItemCount:6),
