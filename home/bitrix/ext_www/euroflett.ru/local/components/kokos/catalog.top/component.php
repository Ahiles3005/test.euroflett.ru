...
if($this->StartResultCache(false, array($arrFilter, ($arParams["CACHE_GROUPS"]==="N"? false: $USER->GetGroups()))))
{
	...
	************************************/
	...
	$arrFilter["!PROPERTY_VITRINA_VALUE"] = "Да";
	...
	$rsElements->NavStart($arParams['NAV_COUNT']);
	//пагинация//
	...
	//вывод пагинации//
	$rsElements->NavPrint("main", false, "", "/local/templates/optima/components/bitrix/system.pagenavigation/top/template.php");
	//вывод пагинации//
	if ($bCatalog && $boolNeedCatalogCache)
	{
