...
///  /usr/bin/php /home/bitrix/ext_www/euroflett.ru/local/php_interface/cron_events_brandt.php

function AgentCheckFeedBrandt()
{   
    if (CModule::IncludeModule('iblock') && CModule::IncludeModule('catalog')) {
        //Получаем список брендов, участвующих в фиде
        $dbObj = CIBlockElement::GetList([], ['IBLOCK_ID' => BRANDS_IBLOCK_ID, 'PROPERTY_IN_FEED_BRANDT_VALUE' => "Y"], false, false, ['NAME']);
        $arBrands = [];
        ...
        $url = "https://brandt-store.ru/bitrix/catalog_export/export_IFh.xml";
