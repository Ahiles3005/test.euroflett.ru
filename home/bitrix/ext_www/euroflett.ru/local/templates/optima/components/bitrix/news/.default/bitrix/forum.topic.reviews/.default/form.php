...
<div class="reviews-reply-form<?=(($arParams['SHOW_MINIMIZED'] == "Y") ? ' global-hide' : '');?>">
		...
		if ($arResult["SHOW_PANEL_ATTACH_IMG"] == "Y"):
			...
			<div class="reviews-reply-field reviews-reply-field-upload">
				...
				if ($iCount < $arParams["FILES_COUNT"]):
					...
					?>
					<div class="reviews-upload-info global-hide" id="upload_files_info_<?=$arParams["form_index"]?>">
						<?
					...
					for ($ii = $iCount; $ii < $arParams["FILES_COUNT"]; $ii++):
						...
						<div class="reviews-upload-file global-hide" id="upload_files_<?=$ii?>_<?=$arParams["form_index"]?>">
