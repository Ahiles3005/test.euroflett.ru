...
<?if (!empty($arResult['ITEMS'])) {?>
	<section class="catalog-top catalog-popular-items" id="catalog-top-<?=$component_counter?>">
		...
		<div class="catalog-items">
			...
			foreach ($arResult['ITEMS'] as $key => $arItem){
				...
				<?if($key==$arParams['FIRST_ELEMENTS_COUNT']):?>
	</section>
	<section class="catalog-top catalog-popular-items" id="catalog-top-<?=$component_counter+1?>">
		<p class="popular-h2 "><?= $arParams['WP_H2_TITLE2'] ?></p>
			<div class="catalog-items">
				<?endif;?>
						...
						<?else: ?>
                            ...
                            <span itemprop="offers" itemscope itemtype="http://schema.org/Offer">
                             <?php include($_SERVER['DOCUMENT_ROOT']."/include/meta_include.php"); ?>
								<div class="catalog-item-price">цена: <span class="price" itemprop="price">
									<?
								...
								<div class="catalog-item-buy">
									...
									?>
									<? else: ?>
										<a href="#preorder" style="width: unset;" data-action="preorder" data-item-title="<?= $productTitle ?>" data-item-url="<?=$arItem['DETAIL_PAGE_URL'];?>" class="button not-available">Под заказ</a>
									<? endif; ?>
								</div>
							<? else: ?>
